				...
				<div class="box-mid-body" id="toggle3">
					<div class="padding">
						...
						<textarea id="xtrastyle" name="xtrastyle"<?php if($socialit_plugopts['autocenter'] == "2" || $socialit_plugopts['autocenter'] == "1"){ ?> disabled=true<?php } ?>><?php
								...
								if($socialit_plugopts['autocenter'] == "2" || $socialit_plugopts['autocenter'] == "1"){
									_e('Custom CSS has been disabled because you are using either the "Auto Space" or "Auto Center" option above.', 'socialit');
...
function get_socialit() {
	...
	if(!$dont_get_si){
		...
		foreach ($socialit_plugopts['bookmark'] as $name) {
			...
			elseif ($name=='socialit-designmoo') {
				$socials.=bookmark_list_item($name, array(
					'post_summary'=>$post_summary,
					'permalink'=>$perms,
					'title'=>$title,
			...
			elseif ($name=='socialit-designbump') {
				$socials.=bookmark_list_item($name, array(
					'post_summary'=>$post_summary,
					'permalink'=>$perms,
					'title'=>$title,
			...
			elseif ($name=='socialit-posterous') {
				$socials.=bookmark_list_item($name, array(
					'post_summary'=>$post_summary,
					'permalink'=>$perms,
					'title'=>$title,
