...
Tags: Social It, Social Bookmarking, Social, Bookmarks Menu, Twitter, Digg, Delicious, StumpleUpon, Reddit, Diigo, YahooBuzz, Technorati, Mixx, Facebook, Myspace, DesignFloat, GoogleBookmarks, Blinklist, LinkedIn, Newsvine, Devmarks, Mister Wrong, Izeby, Tipd, Friendfeed, BlogMarks, Twittley, Fwisp, DesignMoo, Identica, PrintFriendly, Netvibes, Techmeme, Ping.fm, Short URL, Gautam
...
= 1.4 (6-10-09) =
* Fixed a serious bug in which their was a problem with bookmarks' array - Thanks to [Torsten](http://xtcmodified.org/) for reporting it
* Fixed a bug in which Short URL options weren't holding their values - Thanks to [Torsten](http://xtcmodified.org/) for reporting it
...
= 1.3 (1-10-09) =
* Fixed a compatibility issue with WordPress-bbPress syncronization Plugin - Thanks to [Ivan](http://bobrik.name/) for the fix and [Torsten](http://xtcmodified.org/) for reporting it
